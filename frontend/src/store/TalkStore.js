	...
	talks: [
		{
			...
			description: "While the application and stepped variables in the themes section ",
			date: "29th Oct 2021",
			time: "5:00PM",
			speakers: 3,
			audience: 14,
		...
		{
			id: 2,
			title: "Shaifaly Girdharwal",
			description: "The following variables are shared across components",
			date: "13th Nov 2021",
			time: "2:00PM",
			speakers: 4,
			audience: 239,
		...
		},
		{
			id: 3,
			title: "Andrew Morgan",
			description: "Adjust the safe area inset bottom of the app",
			date: "21st Nov 2021",
			time: "7:30PM",
			speakers: 2,
			audience: 371,
